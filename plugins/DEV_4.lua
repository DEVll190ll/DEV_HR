...
local reply_id = msg['id']
  if matches[1] == "المطور" then
    local ii02ii = [[يہۧعہۧمہۧل بہۧوتہۧ سہۧآقہۧط ع مہۧجہۧمہۧوعآت 5K 🌞✨

≪ تہۧم صہۧنہۧع آلہۧبہۧوتہۧ مہۧن قہۧبہۧل آلہۧمہۧطور 🙁🍷 ≫
 الز؏ــــيـم❙#حسين_محمد👨🏼‍💻🥇
     
  ≪مہۧعہۧرفہۧ آلہۧمہۧطہۧور 🐸🎈 ≫                      『 @ll190ll 』
                      
    ≪بہۧوتہۧ آلہۧتہۧوآصہۧل 😚≫  
   
                                          『 @MX313_BOT 』

                                       ≪مہۧعہۧرفہۧ آلہۧمہۧطہۧور الثاني 🌞✨ ≫
...
-- للفوك انتهينا من ملف شنو اني 
  ...
  if matches[1] == "@llSNll" then -- خلي معرفك مكان معرفي
  local sudo = 295669242     -- خلي الايدي مالتك مكان  ايديي
...
local text = "آهہۧلآ وسہۧهہۧلآ بہۧكہ/ي 🌞✨ @"..msg.from.username..'\n\n آنہۧتہ آلآن🏃🏻تہۧتہۧحہۧدثہ مہۧع بہۧوتہ  SAQT 🤖✅ \n\n لہۧلتہۧحہۧدث مہۧع آلہۧمہۧطہۧور 🕵️ \n\n 🌞☄️ Dev @llSNll \n\n لہۧسہۧتہ آنہۧآ آلہۧمہۧطہۧور آلہۧوحہۧيہكہۧننہۧيے آفہۧضہلہۧهم 🐸🍷 \n\nآلہۧقہۧناة الہۧيے تہۧسہۧآهہۧم بہۧمہۧسہۧآعہۧدتہۧكہ🤖🔝\n\n📡 # @DEV_HR وخہۧآصہۧة لہۧلہۧشہٰروحہٰآتہٰ 💋😻\n'    reply_msg(reply_id, text, ok_cb, false) end
  ...
  if matches[1] == "شغل" and is_sudo(msg) then   -- ملف رست وحدث وريديس اذا كان البوت شغال استخدمها تفيدك  يعني اذا ساعتين وبوتك يوكف 
